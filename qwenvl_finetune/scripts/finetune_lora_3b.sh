...
# Qwen2.5-VL 3B LoRA Fine-tuning Script
# This script provides automated LoRA fine-tuning with GPU detection and optimal settings
...
CONFIG_FILE="${PROJECT_ROOT}/configs/lora/lora_3b.yaml"
...
# Skip DeepSpeed for LoRA training
